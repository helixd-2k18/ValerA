...
static const char* JavaCPP_members[47][12] = {
        ...
        { "sizeof" },
        { "sizeof", "modelview", "modelviewPrev", "mdata", "projection", "projectionInv", "modelviewInv", "modelviewPrevInv", "tdata", "rdata" },
        { NULL },
        { NULL },
        { "sizeof", "transform", "primitiveCount", "attributes", "mesh_flags", "vertexAttribute", "material", "reserved", "firstVertex", "indexBufferView", "indexType" },
        { NULL },
        ...
        { "sizeof", "normal", "diffuse", "emission", "pbrAGM", "diffuseTexture", "udata", "emissionTexture", "normalTexture", "pbrAGMTexture" },
        { "sizeof" },
        { NULL },
        { NULL },
        { NULL } };
static int JavaCPP_offsets[47][12] = {
        ...
        { sizeof(::vlr::ConstantDesc), offsetof(::vlr::ConstantDesc, modelview), offsetof(::vlr::ConstantDesc, modelviewPrev), offsetof(::vlr::ConstantDesc, mdata), offsetof(::vlr::ConstantDesc, projection), offsetof(::vlr::ConstantDesc, projectionInv), offsetof(::vlr::ConstantDesc, modelviewInv), offsetof(::vlr::ConstantDesc, modelviewPrevInv), offsetof(::vlr::ConstantDesc, tdata), offsetof(::vlr::ConstantDesc, rdata) },
        { -1 },
        { -1 },
        { sizeof(::vlr::GeometryDesc), offsetof(::vlr::GeometryDesc, transform), offsetof(::vlr::GeometryDesc, primitiveCount), offsetof(::vlr::GeometryDesc, attributes), offsetof(::vlr::GeometryDesc, mesh_flags), offsetof(::vlr::GeometryDesc, vertexAttribute), offsetof(::vlr::GeometryDesc, material), offsetof(::vlr::GeometryDesc, reserved), offsetof(::vlr::GeometryDesc, firstVertex), offsetof(::vlr::GeometryDesc, indexBufferView), offsetof(::vlr::GeometryDesc, indexType) },
        { -1 },
        ...
        { sizeof(::vlr::MaterialUnit), offsetof(::vlr::MaterialUnit, normal), offsetof(::vlr::MaterialUnit, diffuse), offsetof(::vlr::MaterialUnit, emission), offsetof(::vlr::MaterialUnit, pbrAGM), offsetof(::vlr::MaterialUnit, diffuseTexture), offsetof(::vlr::MaterialUnit, udata), offsetof(::vlr::MaterialUnit, emissionTexture), offsetof(::vlr::MaterialUnit, normalTexture), offsetof(::vlr::MaterialUnit, pbrAGMTexture) },
        { sizeof(::vlj::Driver) },
        { -1 },
        { -1 },
        { -1 } };
