...
static const char* JavaCPP_members[47][12] = {
        ...
        { NULL },
        { "sizeof" },
        { "sizeof", "constants", "translucent", "framebuffer", "instanceSet", "layout", "opaque" },
        { "sizeof", "vertexShader", "fragmentShader", "geometryShader" },
        { "sizeof" },
        { "sizeof", "modelviewInv", "modelviewPrev", "tdata", "modelview", "mdata", "projection", "projectionInv", "rdata", "modelviewPrevInv" },
        { NULL },
        { NULL },
        { "sizeof", "transform", "primitiveCount", "attributes", "indexType", "indexBufferView", "material", "reserved", "vertexAttribute", "mesh_flags", "firstVertex" },
        { NULL },
        { "sizeof", "transform", "accelerationStructureHandle" },
        { NULL },
        { "sizeof", "layout", "accelerationTop" },
        { "sizeof", "rasterization", "layout", "rayTracing" },
        { "sizeof", "attributes", "bindings", "bufferViews" },
        { "sizeof" },
        { "sizeof" },
        { "sizeof", "count", "enableCPU", "uniform", "enableGL" },
        { "sizeof", "geometrySet", "initials", "instanceSet" },
        { "sizeof", "normal", "emission", "udata", "diffuseTexture", "emissionTexture", "pbrAGMTexture", "diffuse", "pbrAGM", "normalTexture" },
        { "sizeof" },
        { NULL },
        { NULL },
        { NULL } };
static int JavaCPP_offsets[47][12] = {
        ...
        { sizeof(::vlr::PipelineCreateInfo), offsetof(::vlr::PipelineCreateInfo, constants), offsetof(::vlr::PipelineCreateInfo, translucent), offsetof(::vlr::PipelineCreateInfo, framebuffer), offsetof(::vlr::PipelineCreateInfo, instanceSet), offsetof(::vlr::PipelineCreateInfo, layout), offsetof(::vlr::PipelineCreateInfo, opaque) },
        { sizeof(::vlr::PipelineStages), offsetof(::vlr::PipelineStages, vertexShader), offsetof(::vlr::PipelineStages, fragmentShader), offsetof(::vlr::PipelineStages, geometryShader) },
        { sizeof(::vlr::InstanceSet) },
        { sizeof(::vlr::ConstantDesc), offsetof(::vlr::ConstantDesc, modelviewInv), offsetof(::vlr::ConstantDesc, modelviewPrev), offsetof(::vlr::ConstantDesc, tdata), offsetof(::vlr::ConstantDesc, modelview), offsetof(::vlr::ConstantDesc, mdata), offsetof(::vlr::ConstantDesc, projection), offsetof(::vlr::ConstantDesc, projectionInv), offsetof(::vlr::ConstantDesc, rdata), offsetof(::vlr::ConstantDesc, modelviewPrevInv) },
        { -1 },
        { -1 },
        { sizeof(::vlr::GeometryDesc), offsetof(::vlr::GeometryDesc, transform), offsetof(::vlr::GeometryDesc, primitiveCount), offsetof(::vlr::GeometryDesc, attributes), offsetof(::vlr::GeometryDesc, indexType), offsetof(::vlr::GeometryDesc, indexBufferView), offsetof(::vlr::GeometryDesc, material), offsetof(::vlr::GeometryDesc, reserved), offsetof(::vlr::GeometryDesc, vertexAttribute), offsetof(::vlr::GeometryDesc, mesh_flags), offsetof(::vlr::GeometryDesc, firstVertex) },
        { -1 },
        ...
        { sizeof(::vlr::RenderCommandCreateInfo), offsetof(::vlr::RenderCommandCreateInfo, rasterization), offsetof(::vlr::RenderCommandCreateInfo, layout), offsetof(::vlr::RenderCommandCreateInfo, rayTracing) },
        ...
        { sizeof(::vlr::DataSetCreateInfo), offsetof(::vlr::DataSetCreateInfo, count), offsetof(::vlr::DataSetCreateInfo, enableCPU), offsetof(::vlr::DataSetCreateInfo, uniform), offsetof(::vlr::DataSetCreateInfo, enableGL) },
        { sizeof(::vlr::AccelerationCreateInfo), offsetof(::vlr::AccelerationCreateInfo, geometrySet), offsetof(::vlr::AccelerationCreateInfo, initials), offsetof(::vlr::AccelerationCreateInfo, instanceSet) },
        { sizeof(::vlr::MaterialUnit), offsetof(::vlr::MaterialUnit, normal), offsetof(::vlr::MaterialUnit, emission), offsetof(::vlr::MaterialUnit, udata), offsetof(::vlr::MaterialUnit, diffuseTexture), offsetof(::vlr::MaterialUnit, emissionTexture), offsetof(::vlr::MaterialUnit, pbrAGMTexture), offsetof(::vlr::MaterialUnit, diffuse), offsetof(::vlr::MaterialUnit, pbrAGM), offsetof(::vlr::MaterialUnit, normalTexture) },
        { sizeof(::vlj::Driver) },
        { -1 },
        { -1 },
        { -1 } };
