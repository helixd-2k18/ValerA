...
static const char* JavaCPP_members[46][12] = {
        ...
        { "sizeof" },
        { "sizeof" },
        { "sizeof", "constants", "layout", "accelerationTop", "framebuffer" },
        { NULL },
        { "sizeof" },
        { "sizeof", "constants", "translucent", "layout", "framebuffer", "instanceSet", "opaque" },
        { "sizeof", "fragmentShader", "geometryShader", "vertexShader" },
        { "sizeof" },
        { "sizeof", "mdata", "modelviewPrev", "rdata", "modelviewInv", "projectionInv", "projection", "modelviewPrevInv", "modelview", "tdata" },
        { NULL },
        { NULL },
        { "sizeof", "transform", "primitiveCount", "attributes", "vertexAttribute", "indexBufferView", "indexType", "firstVertex", "material", "mesh_flags", "reserved" },
        { NULL },
        ...
        { "sizeof", "normal", "diffuseTexture", "pbrAGMTexture", "udata", "diffuse", "pbrAGM", "emission", "normalTexture", "emissionTexture" },
        { "sizeof" },
        { NULL },
        { NULL } };
static int JavaCPP_offsets[46][12] = {
        ...
        { sizeof(::vlr::SetBase) },
        { sizeof(::vlr::RayTracingCreateInfo), offsetof(::vlr::RayTracingCreateInfo, constants), offsetof(::vlr::RayTracingCreateInfo, layout), offsetof(::vlr::RayTracingCreateInfo, accelerationTop), offsetof(::vlr::RayTracingCreateInfo, framebuffer) },
        { -1 },
        { sizeof(::vlr::Constants) },
        { sizeof(::vlr::PipelineCreateInfo), offsetof(::vlr::PipelineCreateInfo, constants), offsetof(::vlr::PipelineCreateInfo, translucent), offsetof(::vlr::PipelineCreateInfo, layout), offsetof(::vlr::PipelineCreateInfo, framebuffer), offsetof(::vlr::PipelineCreateInfo, instanceSet), offsetof(::vlr::PipelineCreateInfo, opaque) },
        { sizeof(::vlr::PipelineStages), offsetof(::vlr::PipelineStages, fragmentShader), offsetof(::vlr::PipelineStages, geometryShader), offsetof(::vlr::PipelineStages, vertexShader) },
        { sizeof(::vlr::InstanceSet) },
        { sizeof(::vlr::ConstantDesc), offsetof(::vlr::ConstantDesc, mdata), offsetof(::vlr::ConstantDesc, modelviewPrev), offsetof(::vlr::ConstantDesc, rdata), offsetof(::vlr::ConstantDesc, modelviewInv), offsetof(::vlr::ConstantDesc, projectionInv), offsetof(::vlr::ConstantDesc, projection), offsetof(::vlr::ConstantDesc, modelviewPrevInv), offsetof(::vlr::ConstantDesc, modelview), offsetof(::vlr::ConstantDesc, tdata) },
        { -1 },
        { -1 },
        { sizeof(::vlr::GeometryDesc), offsetof(::vlr::GeometryDesc, transform), offsetof(::vlr::GeometryDesc, primitiveCount), offsetof(::vlr::GeometryDesc, attributes), offsetof(::vlr::GeometryDesc, vertexAttribute), offsetof(::vlr::GeometryDesc, indexBufferView), offsetof(::vlr::GeometryDesc, indexType), offsetof(::vlr::GeometryDesc, firstVertex), offsetof(::vlr::GeometryDesc, material), offsetof(::vlr::GeometryDesc, mesh_flags), offsetof(::vlr::GeometryDesc, reserved) },
        { -1 },
        ...
        { sizeof(::vlr::MaterialUnit), offsetof(::vlr::MaterialUnit, normal), offsetof(::vlr::MaterialUnit, diffuseTexture), offsetof(::vlr::MaterialUnit, pbrAGMTexture), offsetof(::vlr::MaterialUnit, udata), offsetof(::vlr::MaterialUnit, diffuse), offsetof(::vlr::MaterialUnit, pbrAGM), offsetof(::vlr::MaterialUnit, emission), offsetof(::vlr::MaterialUnit, normalTexture), offsetof(::vlr::MaterialUnit, emissionTexture) },
        { sizeof(::vlj::Driver) },
        { -1 },
        { -1 } };
