...
static const char* JavaCPP_members[47][12] = {
        ...
        { NULL },
        { "sizeof" },
        { "sizeof", "constants", "layout", "framebuffer", "instanceSet", "opaque", "translucent" },
        { "sizeof" },
        { "sizeof", "vertexShader", "geometryShader", "fragmentShader" },
        { "sizeof", "projection", "modelviewInv", "tdata", "modelviewPrev", "projectionInv", "rdata", "modelview", "modelviewPrevInv", "mdata" },
        { NULL },
        { NULL },
        { "sizeof", "transform", "primitiveCount", "attributes", "mesh_flags", "indexBufferView", "firstVertex", "reserved", "indexType", "vertexAttribute", "material" },
        { NULL },
        ...
        { "sizeof", "normal", "pbrAGMTexture", "diffuse", "normalTexture", "emissionTexture", "udata", "diffuseTexture", "emission", "pbrAGM" },
        { "sizeof" },
        { NULL },
        { NULL },
        { NULL } };
static int JavaCPP_offsets[47][12] = {
        ...
        { sizeof(::vlr::PipelineCreateInfo), offsetof(::vlr::PipelineCreateInfo, constants), offsetof(::vlr::PipelineCreateInfo, layout), offsetof(::vlr::PipelineCreateInfo, framebuffer), offsetof(::vlr::PipelineCreateInfo, instanceSet), offsetof(::vlr::PipelineCreateInfo, opaque), offsetof(::vlr::PipelineCreateInfo, translucent) },
        ...
        { sizeof(::vlr::ConstantDesc), offsetof(::vlr::ConstantDesc, projection), offsetof(::vlr::ConstantDesc, modelviewInv), offsetof(::vlr::ConstantDesc, tdata), offsetof(::vlr::ConstantDesc, modelviewPrev), offsetof(::vlr::ConstantDesc, projectionInv), offsetof(::vlr::ConstantDesc, rdata), offsetof(::vlr::ConstantDesc, modelview), offsetof(::vlr::ConstantDesc, modelviewPrevInv), offsetof(::vlr::ConstantDesc, mdata) },
        { -1 },
        { -1 },
        { sizeof(::vlr::GeometryDesc), offsetof(::vlr::GeometryDesc, transform), offsetof(::vlr::GeometryDesc, primitiveCount), offsetof(::vlr::GeometryDesc, attributes), offsetof(::vlr::GeometryDesc, mesh_flags), offsetof(::vlr::GeometryDesc, indexBufferView), offsetof(::vlr::GeometryDesc, firstVertex), offsetof(::vlr::GeometryDesc, reserved), offsetof(::vlr::GeometryDesc, indexType), offsetof(::vlr::GeometryDesc, vertexAttribute), offsetof(::vlr::GeometryDesc, material) },
        { -1 },
        ...
        { sizeof(::vlr::MaterialUnit), offsetof(::vlr::MaterialUnit, normal), offsetof(::vlr::MaterialUnit, pbrAGMTexture), offsetof(::vlr::MaterialUnit, diffuse), offsetof(::vlr::MaterialUnit, normalTexture), offsetof(::vlr::MaterialUnit, emissionTexture), offsetof(::vlr::MaterialUnit, udata), offsetof(::vlr::MaterialUnit, diffuseTexture), offsetof(::vlr::MaterialUnit, emission), offsetof(::vlr::MaterialUnit, pbrAGM) },
        { sizeof(::vlj::Driver) },
        { -1 },
        { -1 },
        { -1 } };
