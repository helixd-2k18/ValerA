...
static const char* JavaCPP_members[47][12] = {
        ...
        { NULL },
        { "sizeof" },
        { "sizeof", "constants", "framebuffer", "translucent", "opaque", "instanceSet", "layout" },
        { "sizeof", "vertexShader", "geometryShader", "fragmentShader" },
        { "sizeof" },
        { "sizeof", "modelviewPrevInv", "projectionInv", "modelviewPrev", "mdata", "rdata", "modelviewInv", "tdata", "projection", "modelview" },
        { NULL },
        { NULL },
        { "sizeof", "transform", "primitiveCount", "attributes", "indexBufferView", "material", "indexType", "firstVertex", "mesh_flags", "reserved", "vertexAttribute" },
        { NULL },
        ...
        { "sizeof", "normal", "udata", "emissionTexture", "diffuseTexture", "pbrAGMTexture", "normalTexture", "diffuse", "pbrAGM", "emission" },
        { "sizeof" },
        { NULL },
        { NULL },
        { NULL } };
static int JavaCPP_offsets[47][12] = {
        ...
        { sizeof(::vlr::PipelineCreateInfo), offsetof(::vlr::PipelineCreateInfo, constants), offsetof(::vlr::PipelineCreateInfo, framebuffer), offsetof(::vlr::PipelineCreateInfo, translucent), offsetof(::vlr::PipelineCreateInfo, opaque), offsetof(::vlr::PipelineCreateInfo, instanceSet), offsetof(::vlr::PipelineCreateInfo, layout) },
        ...
        { sizeof(::vlr::ConstantDesc), offsetof(::vlr::ConstantDesc, modelviewPrevInv), offsetof(::vlr::ConstantDesc, projectionInv), offsetof(::vlr::ConstantDesc, modelviewPrev), offsetof(::vlr::ConstantDesc, mdata), offsetof(::vlr::ConstantDesc, rdata), offsetof(::vlr::ConstantDesc, modelviewInv), offsetof(::vlr::ConstantDesc, tdata), offsetof(::vlr::ConstantDesc, projection), offsetof(::vlr::ConstantDesc, modelview) },
        { -1 },
        { -1 },
        { sizeof(::vlr::GeometryDesc), offsetof(::vlr::GeometryDesc, transform), offsetof(::vlr::GeometryDesc, primitiveCount), offsetof(::vlr::GeometryDesc, attributes), offsetof(::vlr::GeometryDesc, indexBufferView), offsetof(::vlr::GeometryDesc, material), offsetof(::vlr::GeometryDesc, indexType), offsetof(::vlr::GeometryDesc, firstVertex), offsetof(::vlr::GeometryDesc, mesh_flags), offsetof(::vlr::GeometryDesc, reserved), offsetof(::vlr::GeometryDesc, vertexAttribute) },
        { -1 },
        ...
        { sizeof(::vlr::MaterialUnit), offsetof(::vlr::MaterialUnit, normal), offsetof(::vlr::MaterialUnit, udata), offsetof(::vlr::MaterialUnit, emissionTexture), offsetof(::vlr::MaterialUnit, diffuseTexture), offsetof(::vlr::MaterialUnit, pbrAGMTexture), offsetof(::vlr::MaterialUnit, normalTexture), offsetof(::vlr::MaterialUnit, diffuse), offsetof(::vlr::MaterialUnit, pbrAGM), offsetof(::vlr::MaterialUnit, emission) },
        { sizeof(::vlj::Driver) },
        { -1 },
        { -1 },
        { -1 } };
