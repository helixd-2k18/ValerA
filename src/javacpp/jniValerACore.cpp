...
static const char* JavaCPP_members[47][12] = {
        ...
        { "sizeof" },
        { "sizeof" },
        { "sizeof", "constants", "framebuffer", "accelerationTop", "layout" },
        { NULL },
        { "sizeof" },
        { "sizeof", "constants", "opaque", "translucent", "instanceSet", "framebuffer", "layout" },
        { "sizeof", "geometryShader", "fragmentShader", "vertexShader" },
        { "sizeof" },
        { "sizeof", "tdata", "rdata", "projectionInv", "mdata", "projection", "modelviewInv", "modelview", "modelviewPrevInv", "modelviewPrev" },
        { NULL },
        { NULL },
        { "sizeof", "transform", "primitiveCount", "attributes", "indexType", "reserved", "firstVertex", "mesh_flags", "vertexAttribute", "indexBufferView", "material" },
        { NULL },
        ...
        { "sizeof", "normal", "emission", "normalTexture", "diffuse", "pbrAGMTexture", "emissionTexture", "pbrAGM", "diffuseTexture", "udata" },
        { "sizeof" },
        { NULL },
        { NULL },
        { NULL } };
static int JavaCPP_offsets[47][12] = {
        ...
        { sizeof(::vlr::SetBase) },
        { sizeof(::vlr::RayTracingCreateInfo), offsetof(::vlr::RayTracingCreateInfo, constants), offsetof(::vlr::RayTracingCreateInfo, framebuffer), offsetof(::vlr::RayTracingCreateInfo, accelerationTop), offsetof(::vlr::RayTracingCreateInfo, layout) },
        { -1 },
        ...
        { sizeof(::vlr::ConstantDesc), offsetof(::vlr::ConstantDesc, tdata), offsetof(::vlr::ConstantDesc, rdata), offsetof(::vlr::ConstantDesc, projectionInv), offsetof(::vlr::ConstantDesc, mdata), offsetof(::vlr::ConstantDesc, projection), offsetof(::vlr::ConstantDesc, modelviewInv), offsetof(::vlr::ConstantDesc, modelview), offsetof(::vlr::ConstantDesc, modelviewPrevInv), offsetof(::vlr::ConstantDesc, modelviewPrev) },
        { -1 },
        { -1 },
        { sizeof(::vlr::GeometryDesc), offsetof(::vlr::GeometryDesc, transform), offsetof(::vlr::GeometryDesc, primitiveCount), offsetof(::vlr::GeometryDesc, attributes), offsetof(::vlr::GeometryDesc, indexType), offsetof(::vlr::GeometryDesc, reserved), offsetof(::vlr::GeometryDesc, firstVertex), offsetof(::vlr::GeometryDesc, mesh_flags), offsetof(::vlr::GeometryDesc, vertexAttribute), offsetof(::vlr::GeometryDesc, indexBufferView), offsetof(::vlr::GeometryDesc, material) },
        { -1 },
        ...
        { sizeof(::vlr::MaterialUnit), offsetof(::vlr::MaterialUnit, normal), offsetof(::vlr::MaterialUnit, emission), offsetof(::vlr::MaterialUnit, normalTexture), offsetof(::vlr::MaterialUnit, diffuse), offsetof(::vlr::MaterialUnit, pbrAGMTexture), offsetof(::vlr::MaterialUnit, emissionTexture), offsetof(::vlr::MaterialUnit, pbrAGM), offsetof(::vlr::MaterialUnit, diffuseTexture), offsetof(::vlr::MaterialUnit, udata) },
        { sizeof(::vlj::Driver) },
        { -1 },
        { -1 },
        { -1 } };
