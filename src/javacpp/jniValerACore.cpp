...
static const char* JavaCPP_members[47][12] = {
        ...
        { NULL },
        { "sizeof" },
        { "sizeof", "constants", "layout", "framebuffer", "translucent", "opaque", "instanceSet" },
        { "sizeof", "vertexShader", "geometryShader", "fragmentShader" },
        { "sizeof" },
        { "sizeof", "mdata", "projectionInv", "modelview", "modelviewInv", "modelviewPrevInv", "projection", "modelviewPrev", "tdata", "rdata" },
        { NULL },
        { NULL },
        { "sizeof", "transform", "primitiveCount", "attributes", "indexBufferView", "firstVertex", "mesh_flags", "material", "reserved", "vertexAttribute", "indexType" },
        { NULL },
        ...
        { "sizeof", "normal", "pbrAGMTexture", "emission", "udata", "normalTexture", "pbrAGM", "diffuseTexture", "diffuse", "emissionTexture" },
        { "sizeof" },
        { NULL },
        { NULL },
        { NULL } };
static int JavaCPP_offsets[47][12] = {
        ...
        { sizeof(::vlr::PipelineCreateInfo), offsetof(::vlr::PipelineCreateInfo, constants), offsetof(::vlr::PipelineCreateInfo, layout), offsetof(::vlr::PipelineCreateInfo, framebuffer), offsetof(::vlr::PipelineCreateInfo, translucent), offsetof(::vlr::PipelineCreateInfo, opaque), offsetof(::vlr::PipelineCreateInfo, instanceSet) },
        ...
        { sizeof(::vlr::ConstantDesc), offsetof(::vlr::ConstantDesc, mdata), offsetof(::vlr::ConstantDesc, projectionInv), offsetof(::vlr::ConstantDesc, modelview), offsetof(::vlr::ConstantDesc, modelviewInv), offsetof(::vlr::ConstantDesc, modelviewPrevInv), offsetof(::vlr::ConstantDesc, projection), offsetof(::vlr::ConstantDesc, modelviewPrev), offsetof(::vlr::ConstantDesc, tdata), offsetof(::vlr::ConstantDesc, rdata) },
        { -1 },
        { -1 },
        { sizeof(::vlr::GeometryDesc), offsetof(::vlr::GeometryDesc, transform), offsetof(::vlr::GeometryDesc, primitiveCount), offsetof(::vlr::GeometryDesc, attributes), offsetof(::vlr::GeometryDesc, indexBufferView), offsetof(::vlr::GeometryDesc, firstVertex), offsetof(::vlr::GeometryDesc, mesh_flags), offsetof(::vlr::GeometryDesc, material), offsetof(::vlr::GeometryDesc, reserved), offsetof(::vlr::GeometryDesc, vertexAttribute), offsetof(::vlr::GeometryDesc, indexType) },
        { -1 },
        ...
        { sizeof(::vlr::MaterialUnit), offsetof(::vlr::MaterialUnit, normal), offsetof(::vlr::MaterialUnit, pbrAGMTexture), offsetof(::vlr::MaterialUnit, emission), offsetof(::vlr::MaterialUnit, udata), offsetof(::vlr::MaterialUnit, normalTexture), offsetof(::vlr::MaterialUnit, pbrAGM), offsetof(::vlr::MaterialUnit, diffuseTexture), offsetof(::vlr::MaterialUnit, diffuse), offsetof(::vlr::MaterialUnit, emissionTexture) },
        { sizeof(::vlj::Driver) },
        { -1 },
        { -1 },
        { -1 } };
