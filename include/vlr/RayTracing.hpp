...
#pragma pack(pop)
    ...
    public: 
        ...
        RayTracing(vkt::uni_ptr<Driver> driver, vkt::uni_arg<RayTracingCreateInfo> info = RayTracingCreateInfo{}) { this->constructor(driver, info); };
        ~RayTracing() {};

        virtual void constructor() {};
        virtual void constructor(vkt::uni_ptr<Driver> driver, vkt::uni_arg<RayTracingCreateInfo> info = RayTracingCreateInfo{});
        virtual void setCommand(vkt::uni_arg<VkCommandBuffer> rasterCommand, vkt::uni_arg<glm::uvec4> meta = glm::uvec4(0u));
        virtual void setCommandFinal(vkt::uni_arg<VkCommandBuffer> rasterCommand, vkt::uni_arg<glm::uvec4> meta = glm::uvec4(0u));
...
namespace vlj {
    ...
    public:
        ...
        RayTracing(vkt::uni_ptr<vlr::Driver> driver, vkt::uni_arg<vlr::RayTracingCreateInfo> info = vlr::RayTracingCreateInfo{}) : Wrap<vlr::RayTracing>(std::make_shared<vlr::RayTracing>(driver, info)) {};
